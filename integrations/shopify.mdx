...
When you enable [tiers](https://docs.trybeans.com/manage/admin/tiers) in Beans, the system automatically adds tier-specific tags to your customers in Shopify. These tags make it easy to identify customer tier levels, create segments, track progression, and target marketing campaigns based on loyalty tiers directly in Shopify.
