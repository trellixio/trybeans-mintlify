...
Replacement tags are available in the BeansEmail automation tool to create personalized or
dynamic email content.

BeansEmail provides template variables that allow you to customize message content. Commonly
...
Merge tags are used to add subscriber information to emails and automated responses. The
