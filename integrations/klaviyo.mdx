...
<Frame>
  <img src="/assets/images/integrations/klaviyo/hero.webp" style={{ borderRadius: '0.5rem' }} />
</Frame>
...
<Frame>
  <img src="/assets/images/integrations/klaviyo/page-events-log.webp" style={{ borderRadius: '0.5rem' }} />
</Frame>
...
<Frame>
  <img src="/assets/images/integrations/klaviyo/klaviyo-view-event.webp" style={{ borderRadius: '0.5rem' }} />
</Frame>

## Preferences

The preferences section gives you additional parameters to configure the integration.

To access the preferences page:

1. Navigate to Klaviyo integration home page
2. Click on **Preferences** in the integration navigation menu.

### List of settings

<ResponseField name="Loyalty points reminder day" required>
  Use this option to select a specific date upon which Beans points reminder metric will be triggered in Klaviyo for all
  customers. If this field is blank the metric will not be triggered.
</ResponseField>
