...
5. Create a
   [**BigCommerce store-level API account**](https://support.bigcommerce.com/s/article/Store-API-Accounts#creating).
6. Copy and paste the Bigcommerce store-level **API keys**
   you created into the designated field and click **Connect**.
