...
To reset your store integration in cases such as: Incorrect API keys, you can safely
disconnect it following this steps:

<Frame>
  <img
    src="/assets/images/integrations/woocommerce/actions-disconnect.gif"
    alt="Disconnect"
    style={{ borderRadius: '0.5rem' }}
  />
</Frame>

1. From your Beans admin dashboard, go to the WooCommerce integration home page.
2. Click on **Status** in the integration navigation menu.
3. From the Actions dropdown in the top right, select **Disconnect integration**.
4. Click on **Disconnect** to complete the process.

<Info>
  Disconnecting the integration will affect synchronisation of data with your store and Beans until the connection is
  restored.
</Info>
