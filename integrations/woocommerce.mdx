...
submitted via WooCommerce product reviews.
...
3. Locate the **Reviews** section and select the **Enable product reviews** check box.
4. Click **Save** to apply your changes.

<Info>
  Activate and configure the [WooCommerce product review
  rule](https://docs.trybeans.com/manage/admin/rules#activate-a-rule) in your Beans admin dashboard for customers to
  earn points.
</Info>
