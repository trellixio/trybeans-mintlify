...
Beans integrates with WooCommerce Product Reviews out of the box. 
After [enabling reviews](https://woocommerce.com/document/product-reviews/) 
on your store, the Product Reviews rule becomes available in the Beans dashboard and you can activate it. 
Once activated, customers will earn points automatically when they leave a review on your products.

<Tip>
  Learn how to [activate and configure the Product Reviews rule](/manage/admin/rules) in the Beans dashboard.
</Tip>

<Frame>
  <img
    src="/assets/images/integrations/woocommerce/woo-product-review.gif"
    alt="WooCommerce-product-reviews-rule"
    style={{ borderRadius: '0.5rem' }}
  />
</Frame>
