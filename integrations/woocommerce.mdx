...
You can set your Beans integration to the LTS (Long-Term Support) version to ensures your
store runs on the most stable and reliable release of the plugin.

<Frame>
  <img
    src="/assets/images/integrations/woocommerce/lts-version.gif"
    alt="LTS-version"
    style={{ borderRadius: '0.5rem' }}
  />
</Frame>

1. From your Beans admin dashboard, navigate to the WooCommerce integration home page.
2. Click on **Status** in the integration navigation menu.
3. From the **Actions** dropdown on the top right, select **Set version to LTS**.
4. Click **Update version** to confirm.
