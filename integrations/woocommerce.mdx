...
The WooCommerce Product Reviews feature lets merchants collect and display customer
feedback directly on product pages. Customers can earn loyalty points for reviews
submitted via WooCommerce product reviews. Follow the
[WooCommerce product review guidelines](https://woocommerce.com/document/product-reviews/) to setup.

<Frame>
  <img
    src="/assets/images/integrations/woocommerce/woo-product-review.gif"
    alt="Woo-product-review"
    style={{ borderRadius: '0.5rem' }}
  />
</Frame>
...
3. Locate the **WooCommerce-product reviews** in the list of available rules and click on **Activate**.
4. Locate the rule in the list of activated rules and click on **Edit**.
5. Update the rule settings and click on **Save**.
...
- **WooCommerce debugging issues**:
  Existing plugins may interfere with Beans features—such as preventing customers from using their
  points. we recommend temporarily deactivating your plugins one by one to identify any conflicts. In rare cases,
  the issue may be theme-related. Switching to a default theme can help test if your current theme is causing
  the problem.
