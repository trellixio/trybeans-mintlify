...
**Store Language**: Set the primary language for your store.
View the list of [supported languages](https://www.trybeans.com/i18n).

**Currency**: Select the primary currency for your store.
View the list of [supported currencies](https://www.trybeans.com/i18n).

**Category**: Choose the category that your products belong to.
Click the dropdown to view and select the appropriate category.
...
2. Click the **Add Admin** button and follow the instructions. The invited team member will
   receive an email to set up their password. Once they complete this step,
   they will have access to the Beans admin interface.

### Remove an admin

1. From the [Team access](https://app.trybeans.com/$realverse/settings/team) page,
   locate the team member you want to delete,
...
with the programming side, or if no integration is available, you or your developer should
explore our API for direct integration.
...
and styling, ensuring that the loyalty experience is tailored to your brand and fully aligns
