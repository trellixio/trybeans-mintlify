...
Integrate Beans with custom E-Commerce platforms
...
[Add Beans to Storefront]()

### Webhooks Integration

Webhooks allow Beans to receive notifications when specific events occur in your store, such
as order completion. These notifications trigger event-based actions, including awarding
points for purchases to ensures synchronization and automation of rewards processing.

[Setup Beans Webhooks]()

## Webhooks

Setting up Beans Webhooks for your online store
...
Setting up beans.js on Your E-commerce Store
