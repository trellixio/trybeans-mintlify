...
Merchants can customize their tier system by defining unique benefits for each level. While Beans provides the
framework for tier management, the implementation of specific benefits requires integration with your ecommerce
platform and custom configuration.

Here are some popular tier benefits you can implement:
...
<Info>
  These benefits require manual configuration through your ecommerce platform. Beans provides the tier structure, but
  you'll need to set up the specific rewards and benefits using your platform's features and capabilities.
</Info>
