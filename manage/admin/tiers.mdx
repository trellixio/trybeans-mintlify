...
<Info>
  These benefits require manual configuration through your ecommerce platform. Beans provides the tier
  structure, but you'll need to set up the specific rewards and benefits using your platform's features
  and capabilities.
</Info>
