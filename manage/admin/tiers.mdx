...
Merchants can set a points multiplier for each tier. For example, customers in the lowest tier may earn 5
point per dollar spent, while those in the highest tier earn 10 points per dollar spent. This encourages
customers to make more purchases to move up the tiers and earn points faster.
