...
Customers may have multiple email addresses. Beans allows customers to receive points to the same account,
regardless of which email they use at checkout. This is ideal for customers with multiple email addresses.
...
2. Using the checkbox on left end of the member listing, select the members to whom you want to perform the actions.
