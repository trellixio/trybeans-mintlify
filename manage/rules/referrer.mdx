...
The Referrals Log allows you to track how many referral invites each customer has sent to your store, making it easier to monitor referrals and view the revenue generated from them.

**To check referrals:**
1. From your Beans admin dashboard, go to the Members page.
2. In the list of logs, you will see the referral activity from each customer.
