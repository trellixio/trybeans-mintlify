...
Customers sometimes experience difficulties when trying to redeem their points, or find that
point redemption is not functioning correctly.

#### Process of Point Redemption

When customers redeem points for a purchase, Beans promptly deducts the points from their
account. If the purchase is not completed for any reason, the redemption is considered null.
Typically, the points are automatically returned to the customer's account within a maximum
of 48 hours.
...
On occasion, especially when using external payment gateways like PayPal, an order might be
marked as validated in your system, even though the payment did not successfully process.
Under such circumstances, the points are only reinstated to the customer's account if the
retailer takes action to cancel the order.
