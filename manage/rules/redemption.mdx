...
<AccordionGroup>
  <Accordion title="Why is the default redemption rate 100 points to $1?">
...
[Learn more about the redemption rate](/manage/rules/redemption#redemption-rate)
  ...
  <Accordion title="Is it possible to update the redemption rate to 1 point worth $1?">
...
they will get 100% cashback. Better list your products for free.
  ...
  <Accordion title="What if my local currency is inflated and has a lot of digits?">
...
The Beans team is aware of this issue and is working on solutions.
  ...
  <Accordion title="Will there be any way in the future to adjust the redemption rate?">
