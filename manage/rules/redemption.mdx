...
customers can receive. These settings help you fine-tune your loyalty program to strike a balance between rewarding customers and maintaining business profitability.
...
If a customer is purchasing a product worth \$10 and has 1000 points (equivalent to \$10), and the maximum discount is set to 50%, they will be able to redeem only 500 points, resulting in a $5 discount.

## Redemption Issues

Customers sometimes experience difficulties when trying to redeem their points, or find that point redemption is not functioning correctly.

#### Process of Point Redemption

When customers redeem points for a purchase, Beans promptly deducts the points from their account. If the purchase is not
completed for any reason, the redemption is considered null. Typically, the points are automatically returned to the customer's account within a maximum of 48 hours.
...
in your system, even though the payment did not successfully process. Under such circumstances, the points are only reinstated to the customer's account if the retailer takes action to cancel the order.


## Non-Eligible Collections
Restrict point redemption for specific products in your store.

While Beans allows customers to redeem points for discounts on most purchases, you may want to exclude certain products from your rewards program. The "Non-Eligible Collections" feature lets you prevent point redemption for selected items, which can be useful for premium products, new releases, or specific collections you want to exempt from discounts.

Through the Beans admin interface, you can choose which product collections will be excluded from point redemption. Once these non-eligible collections are set, customers cannot redeem points for products in those collections, even if they are members of your rewards program.
