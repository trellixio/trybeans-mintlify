...
Enable customers to redeem points for specific products in your store.

In addition to allowing customers to use points for discounts on purchases, Beans offers other reward options. With the "Eligible Collections" feature, you can designate certain products as eligible for point redemption. This is particularly useful for special collections or featured items, boosting customer engagement in your rewards program.

Through the Beans admin interface, you can select which product collections are eligible for point redemption. Once the eligible collections are set and saved, customers can redeem points only when purchasing products from those collections.

<Warning>Customers must be members of your rewards program to redeem points for eligible products.</Warning>
...
3. Find the Eligible Collections section.
4. Choose the collection of products that will be exclusively redeemable with points.
